...
// Current Tag
const Current_tag = React.lazy(() => import('./views/current_tag/Current_tag'))

// Heart Map
const Heart_map = React.lazy(() => import('./views/heart_map/Heart_map'))
...
const routes = [
  ...
  { path: '/current_tag', name: 'Current_tag', component: Current_tag },
  { path: '/heart_map', name: 'Heart_map', component: Heart_map },
